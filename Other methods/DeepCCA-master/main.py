...
if __name__ == '__main__':
    ...
    layer_sizes1 = [815, 815,  outdim_size]
    layer_sizes2 = [2613, 2613,  outdim_size]
    ...
    data1 = load_data('data/ATAC_seq.csv','data/label.csv')
    data2 = load_data('data/RNA_seq_2613.csv','data/label.csv')
